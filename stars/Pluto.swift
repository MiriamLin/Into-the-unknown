...
struct Pluto: View {
    ...
    @State private var speed2: Double = 10000000000000
    @State private var distance: Double = 5900000000
                        ...
                        if nextcard{
                            ...
                            ZStack{
                                ...
                                if back{
                                    ZStack{
                                        if ans == 0 {
                                            Text("Which is NOT one of the criteria to be a planet?")
                                                .padding()
                                            ...
                                            Button(action: {
                                                ...
                                                Text("Massive enough to shape it into a nearly round form")
                                                    .padding()
                                                    .font(.system(size: 30, design: .rounded))
                                                    .frame(width: geometry.size.width * 0.63, height: geometry.size.height * 0.1)
                                                    .foregroundColor(.black)
                                            ...
                                            Button(action: {
                                                ...
                                                Text("Clearing other objects in its orbit")
                                                    .padding()
                                                    .font(.system(size: 30, design: .rounded))
                                                    .frame(width: geometry.size.width * 0.63, height: geometry.size.height * 0.1)
                                                    .foregroundColor(.black)
                                            ...
                                            if ans == 1 || ans == 2 || ans == 3 {
                                                ...
                                                Text("Correct! Planets like Mercury and Venus do not have moons")
                                                    .padding()
                                                    .font(.system(size: 30, design: .rounded))
                                                    .frame(width: geometry.size.width * 0.63, height: geometry.size.height * 0.18)
                                                    .foregroundColor(.white)
...
struct Pluto_previews: PreviewProvider{
    static var previews: some View{
        NavigationStack{
            Pluto().environmentObject(collect())
        }
    }
}
