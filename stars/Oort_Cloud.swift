                        ...
                        ZStack{
                            ...
                            if back{
                                ZStack{
                                    ...
                                    Text("Comets are made of ice, dust, and gas. When they come close to the Sun, solar radiation and solar wind affect them, creating a tail that always points away from the Sun.")
...
struct Oort_Cloud_previews: PreviewProvider{
    static var previews: some View{
        NavigationStack{
            Oort_Cloud().environmentObject(collect())
        }
    }
}
