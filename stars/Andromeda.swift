...
struct Andromeda: View {
    ...
    @State private var distance_str = "23,650,000,000,000,000,000 km"
...
struct Andromeda_previews: PreviewProvider{
    static var previews: some View{
        NavigationStack{
            Andromeda().environmentObject(collect())
        }
    }
}
