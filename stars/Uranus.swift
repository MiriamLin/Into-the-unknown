...
struct Uranus: View {
    ...
    @State private var distance: Double = 2900000000
                    ...
                    if showCard {
                        ...
                        ZStack{
                            ...
                            if back{
                                ZStack{
                                    if ans == 0 {
                                        Text("What gives Uranus its blue-green color?")
                                            .padding()
                                        ...
                                        if ans == 1 || ans == 2 || ans == 4 {
                                            ...
                                            Text("Correct! Methane gas in Uranus's atmosphere absorbs red light and reflects blue, making the planet look blue.")
                                                .padding()
                                                .font(.system(size: 30, design: .rounded))
                                                .frame(width: geometry.size.width * 0.63, height: geometry.size.height * 0.18)
                                                .foregroundColor(.white)
...
struct Uranus_previews: PreviewProvider{
    static var previews: some View{
        NavigationStack{
            Uranus().environmentObject(collect())
        }
    }
}
