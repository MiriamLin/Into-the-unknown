...
struct Laniakea: View {
    ...
    @State private var speed2_str = "100,000,000,000,000,000,000,000 km/s"
    @State private var distance_str = "4,920,000,000,000,000,000,000 km"
    @State private var time: Double = 4.92
...
struct Laniakea_previews: PreviewProvider{
    static var previews: some View{
        NavigationStack{
            Laniakea().environmentObject(collect())
        }
    }
}
