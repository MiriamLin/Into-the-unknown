                ...
                ZStack {
                    ...
                    if showCard {
                        ...
                        ZStack{
                            ...
                            if back{
                                ZStack{
                                    Text("The Little Prince's rose")
                                        .fontWeight(.heavy)
                                        .font(.system(size: 48))
                                        .position(x: geometry.size.width * 0.52, y: geometry.size.height * 0.15)
                                    /*
                                     Text("B-612, home of the Little Prince is an asteroid.")
                                    ...
                                    VStack(alignment: .leading, spacing: 10) {
                                        Text("If you love a flower that lives on a star, it is sweet to look at the sky at night. All the stars are a-bloom with flowers.")
                                            .font(.title2)
                                            .fontWeight(.medium)
                                            .italic()
                                            .foregroundColor(.white)
...
struct Asteroid_previews: PreviewProvider{
    static var previews: some View{
        NavigationStack{
            Asteroid().environmentObject(collect())
        }
    }
}
