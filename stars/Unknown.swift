...
//  Into the unknown
//
//  Created by Miriam Lin on 2024/2/17.
//
...
struct Unknown: View {
    ...
    @State private var distance_str = " ? km"
    @State private var time: Double = 9.99
                        ...
                        ZStack{
                            ...
                            if back{
                                ZStack{
                                    ...
                                    .position(x: UIScreen.main.bounds.width * 0.52, y:UIScreen.main.bounds.height * 0.76)
                                    Button(action: {
                                        self.nextstar = true
                                        c.card17 = true
...
struct Unknown_previews: PreviewProvider{
    static var previews: some View{
        NavigationStack{
            Unknown().environmentObject(collect())
        }
    }
}
